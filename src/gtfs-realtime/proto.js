    ...
    TripUpdate.StopTimeUpdate = (function () {
      ...
      StopTimeUpdate.StopTimeProperties = (function () {
        ...
        StopTimeProperties.fromObject = function fromObject(object) {
          if (
            object instanceof
            $root.transit_realtime.TripUpdate.StopTimeUpdate.StopTimeProperties
          )
            return object;
          let message =
            new $root.transit_realtime.TripUpdate.StopTimeUpdate.StopTimeProperties();
  ...
  transit_realtime.Alert = (function () {
    ...
    Alert.toObject = function toObject(message, options) {
      ...
      if (
        ...
        object.effectDetail = $root.transit_realtime.TranslatedString.toObject(
          message.effectDetail,
          options,
        );
      return object;
  ...
  transit_realtime.TranslatedImage = (function () {
    ...
    TranslatedImage.LocalizedImage = (function () {
      ...
      LocalizedImage.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.transit_realtime.TranslatedImage.LocalizedImage();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
  ...
  transit_realtime.Shape = (function () {
    ...
    Shape.verify = function verify(message) {
      if (typeof message !== "object" || message === null)
        return "object expected";
      if (message.shapeId != null && message.hasOwnProperty("shapeId"))
        if (!$util.isString(message.shapeId)) return "shapeId: string expected";
      if (
        message.encodedPolyline != null &&
